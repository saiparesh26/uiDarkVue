            ...
            <div class="modal" ref="modal">
                <div class="modal-background"></div>
                    <div class="modal-card">
                        <header class="modal-card-head" style="background: #7F3CD2">
                        ...
                        <!-- Attributes -->
                        <div>
                            <p class="title is-5">Attributes <span style = "margin-top: 10px; margin-left:10px"> <button class="button is-small is-rounded" style="background: #7F3CD2" @click="showAllAttributesModal"> <span class="has-text-white"> Show All </span></button> </span> </p>
                            <div class="content">
                                <ul>
